// ======================================================================
// step_funzionanti_def.v generated from TopDesign.cysch
// 07/25/2023 at 18:58
...
module top ;
	...
	wire [0:0] tmpOE__Pin_LED_CMT_net;
	wire [0:0] tmpFB_0__Pin_LED_CMT_net;
	wire [0:0] tmpIO_0__Pin_LED_CMT_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED_CMT_net;
	electrical [0:0] tmpSIOVREF__Pin_LED_CMT_net;

	cy_psoc3_pins_v1_10
		#(.id("7df7699f-5b28-4f7e-b0a2-e9ea1c247866"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LED_CMT
		 (.oe(tmpOE__Pin_LED_CMT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LED_CMT_net[0:0]}),
		  .io({tmpIO_0__Pin_LED_CMT_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED_CMT_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LED_CMT_net[0:0]}),
		  .annotation({Net_28}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_LED_CMT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_2 PWM_LED_ACC (
        .capture(1'b0),
        .clock(Net_44),
        .cmp_sel(1'b0),
        .enable(1'b1),
        ...
        .tc(Net_55),
        .trigger(1'b0));
    defparam PWM_LED_ACC.Resolution = 8;


	cy_clock_v1_0
		#(.id("e5f86ab8-44d8-48bc-b35d-b06d1ddd115a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Pin_LED_ACC_net;
	wire [0:0] tmpFB_0__Pin_LED_ACC_net;
	wire [0:0] tmpIO_0__Pin_LED_ACC_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED_ACC_net;
	electrical [0:0] tmpSIOVREF__Pin_LED_ACC_net;

	cy_psoc3_pins_v1_10
		#(.id("c7b6dfaa-3f2f-4dc6-994d-c80cc8317029"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LED_ACC
		 (.oe(tmpOE__Pin_LED_ACC_net),
		  .y({Net_65}),
		  .fb({tmpFB_0__Pin_LED_ACC_net[0:0]}),
		  .io({tmpIO_0__Pin_LED_ACC_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED_ACC_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LED_ACC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LED_ACC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
