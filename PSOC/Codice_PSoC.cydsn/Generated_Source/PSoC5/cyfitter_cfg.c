...
#define BS_UDB_1_3_1_CONFIG_VAL ((const uint8 CYFAR *)0x480004B0u)
...
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000538u)

/* IOPINS0_8 Address: CYREG_PRT15_DM0 Size (bytes): 8 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000544u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x4800054Cu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG2_CFG0), 0x2DC6u);
